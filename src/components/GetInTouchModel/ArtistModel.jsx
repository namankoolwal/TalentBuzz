...
const ArtistModel = ({ setShow }) => {
  ...
  const handleRedirect = () => {
    window.open(import.meta.env.VITE_GOOGLE_FORM_JOIN_GROUP, "_blank");
  };
  return (
    <>
      <div className=" text-black">
        ...
        <form onSubmit={handleSubmit} className="mt-6  relative">
          ...
          <div className=" flex flex-col mt-14 md:mt-0 gap-5 md:gap-2">
            ...
            <button
              className="bg-[#7349bd] bg-opacity-20 outline-none border-2 border-gray-300 focus:border-gray-400  rounded-md py-2.5 md:py-1.5 px-3 text-left text-gray-600 text-2xl md:text-sm hover:bg-opacity-40 hover:text-gray-700 flex items-center justify-between"
              onClick={handleRedirect}
            >
              {" "}
              Fill This Form To Join Artist Group &rarr;
