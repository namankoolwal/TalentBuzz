        ...
        <div className="top flex flex-col md:flex-row gap-12 md:gap-10 text-[1.35rem] md:text-[1rem] py-20 md:py-10 px-[5vw]  items-start justify-evenly">
          ...
          <img loading='lazy' src={logo} alt="logo" className="w-[28vw] md:w-[8vw]  md:-mb-5" />
            ...
            <div className="socials w-full flex items-center justify-evenly md:justify-between gap-5 p-2 pl-0">
              ...
              <span className="bg-white text-black font-bold text-4xl md:text-lg p-3 md:p-2 rounded-full"><FaLinkedinIn /></span>
              <span className="bg-white text-black font-bold text-4xl md:text-lg p-3 md:p-2 rounded-full"><FaYoutube /></span>
              <span className="bg-white text-black font-bold text-4xl md:text-lg p-3 md:p-2 rounded-full"><FaFacebook /></span>
            </div>
          </div>
          <div className="flex flex-row w-full md:w-fit gap-28 text-[1.35rem] md:text-[1rem] items-start justify-between pr-10 md:pr-0 md:justify-evenly">
            ...
            <div className="third list-none space-y-2 flex flex-col flex-wrap">
          ...
          <div className='fourth list-none space-y-3 flex flex-col'>
            ...
            <li> <button className='bg-[#CD3056] rounded-lg p-4 md:p-2 flex items-center gap-4 md:gap-2 w-full'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="fill-current w-12 md:w-5  text-gray-50">
