    ...
    <section className='px-[5.5vw] my-[60px] md:my-[120px] h-full '>
        ...
        >
            <div className='flex flex-col items-center justify-center gap-10 px-8'>
                <div className='font-bold text-[2rem] md:text-[2.5rem] '> 
                If You’re an Artist, Contact Us
                </div>
                <div className='text-[1.1rem] md:text-[1.5rem] md:w-[90%] text-center text-pretty'>
                ...
                <button className='bg-[#EFAA76] text-[1.1rem] text-black w-fit  px-5 py-2 rounded-md flex items-center justify-between gap-3'>Contact Us</button>
            </div>
        </div>
    </section>
  )
