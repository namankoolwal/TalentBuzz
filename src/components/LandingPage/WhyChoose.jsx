      ...
      <div className='flex flex-col items-center gap-[40px] lg:gap-[2.5rem] h-full'>
        ...
        {/* ********** */}
          ...
          <div className='cardcontent relative flex flex-col justify-between gap-5 md:gap-8 '>
              ...
              <button className='bg-[#EFAA76] mt-2 md:mt-0 py-3 px-4 rounded-md text-2xl md:text-lg text-black w-fit' onClick={handelClick}>Book Now</button>
          </div>
          </div>
        {/* ********** */}
          ...
          <div className='cardcontent relative flex flex-col justify-between gap-6 md:gap-8 '>
              ...
              <button className='bg-[#EFAA76] mt-2 md:mt-0 py-3 px-4 text-2xl md:text-lg rounded-md text-black w-fit' onClick={handelClick}>Book Now</button>
          </div>
          </div>
        {/* ********** */}
