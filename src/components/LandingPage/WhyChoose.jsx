      ...
      <div className='flex flex-col items-center gap-[40px] lg:gap-[2.5rem] h-full'>
        ...
        {/* ********** */}
          ...
          <div className='cardcontent relative flex flex-col justify-between gap-5 md:gap-8 '>
              ...
              <button className='bg-[#EFAA76] p-2 rounded-md text-xl md:text-base text-black w-fit' onClick={handelClick}>Book Now</button>
          </div>
          </div>
        {/* ********** */}
          ...
          <div className='cardcontent relative flex flex-col justify-between gap-5 md:gap-8 '>
              ...
              <button className='bg-[#EFAA76] p-2 text-xl md:text-base rounded-md text-black w-fit' onClick={handelClick}>Book Now</button>
          </div>
          </div>
        {/* ********** */}
