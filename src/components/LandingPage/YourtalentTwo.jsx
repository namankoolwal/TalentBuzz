...
const YourtalentTwo = () => {
    ...
    return (
        ...
        <div className=" gallery  -yellow-400 mt-40 flex flex-col-reverse md:flex-row relative">
            <div className="leftblock h-full w-full md:w-1/2 ml-auto  -violet-200 ">
            ...
            <div className="rightblock backgroundChange bg-black  -green-400 sticky top-0 md:relative w-full md:w-1/2  flex flex-col justify-start items-center md:items-end md:pr-10">
            <div className="work-right-bl w-full md:h-screen md:sticky top-0 flex flex-col items-center lg:items-end justify-center">
                <div className="my-24 relative md:my-0 w-[48vw] md:w-full lg:w-[20vw] h-[100vw] md:h-[90vw] lg:h-[40vw] flex justify-center border-[4px] border-zinc-700 rounded-3xl  -4 -zinc-900 ring-offset-2 ring-4 ring-offset-zinc-700 ring-zinc-800 ">
