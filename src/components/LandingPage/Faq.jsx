...
const Faq = () => {
    return (
        <div className='px-[5.5vw] my-[120px] w-full  '>
            <div className='border-4 border-[#b8b0b0] rounded-lg flex gap-10 h-full justify-center p-5'>
                <div className='faqLeft w-[60%] flex flex-col gap-5 p-5'>
                ...
                <div className='faqRight w-[40%] p-7 pb-3 flex flex-col gap-5'>
