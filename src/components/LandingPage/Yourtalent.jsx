        ...
        <div className='bg-[#181818] px-[5.5vw] py-20 my-[120px] min-h-screen w-full'>
            <div className='flex items-end '>
                <div className='left w-[41%] '>
                    <h2 className='text-[2.5rem] md:text-[4rem] font-semibold leading-tight'>Your Talent Searching Hub</h2>
                </div>
            ...
            <div className='w-full relative  mt-40'>
                <div className='flex items-start px-5 my-20 h-[220vh] '>
                ...
                <div className='flex items-start px-5 my-20 h-[220vh] '>
                    ...
                    <div className='imagediv w-1/2  sticky top-0 flex justify-end'>
                        ...
                        <img src={img2} alt="img2" className='w-[60%] ' />
                    </div>
                </div>
