    ...
    <div className='px-[5.5vw] my-[60px] md:my-[120px] h-full'>
        ...
        >
            <div className='flex flex-col items-center justify-center gap-10 md:p-8'>
                ...
                <div className='text-[1.5rem] w-[100%] text-center text-pretty'>We know the struggles artists go through—standing out, getting noticed, and finding meaningful work. TalentBuzzz is here to help you overcome these challenges. Join us, and let your talent shine.</div>
            </div>
        </div>
    </div>
  )
