    ...
    <div className='md:px-[5.5vw] my-[60px] md:my-[120px] h-full'>
      ...
      >
        <div className='flex flex-col items-center justify-center gap-10 md:p-8'>
          ...
          <ul className="flex justify-center items-center gap-8 px-3 md:px-28 flex-wrap ">
          ...
          <div className='text-[1.5rem] w-[100%]  text-center mt-3 px-4 text-pretty'>Let Talentbuzzz be your platform to grow, connect, and let your talent shine!</div>
        </div>
      </div>
    </div>
  )
